//
//  NewSharedCatalogueImgPreviewCell.swift
//  Emotipics
//
...
class NewSharedCatalogueImgPreviewCell: UICollectionViewCell, UIScrollViewDelegate {
    
    static let identifier = "NewSharedCatalogImgCell"
