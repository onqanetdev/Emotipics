...
class ForgetPasswordAPICaller {
    static func forgetPasswordAPICaller(userEmail: String , CompletionHandler: @escaping(_ result: Result<ForgetPasswordResModel, NetworkError>) -> Void){
...
//        print("Access Token--->",accessToken)
        ...
        let urlString = baseURL + APIEndpoint.forgetPassword.rawValue
       ...
       // request.setValue("Bearer " + accessToken, forHTTPHeaderField: "Authorization")
        ...
        URLSession.shared.dataTask(with: request) { dataResponse, urlResponse, error in
            ...
            if error == nil ,
               ...
               let jsonResponse = try? JSONDecoder().decode(ForgetPasswordResModel.self, from: data) {
                print("My JSON Response from Forget Password✅✅✅✅", jsonResponse)
