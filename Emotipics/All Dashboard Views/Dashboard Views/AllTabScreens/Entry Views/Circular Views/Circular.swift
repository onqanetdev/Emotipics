...
//  ChartDemoApp
//
//  Created by Onqanet on 07/03/25.
//
...
open class Circular: UIView {
    ...
    //MARK:- Initialization
    public init(percentages: [Double], colors: [UIColor], animationType: AnimationStyle = .animationFanAll, showPercentageStyle: PercentageStyle = .none) {
