...
class ProfileViewController: UIViewController {
    ...
    var contentsTitle = ["Home", "My Account", "Catalogue", "Contact List","Birthday Wishes List", "Groups", "About Us", "Terms & Conditions", "Support", "Logout"]
    
    var respectiveImg = ["Home","MyAccount", "Catalogue", "ContactList", "BirthdayIcon", "Group", "About Us", "Terms", "Support", "Logout"]
